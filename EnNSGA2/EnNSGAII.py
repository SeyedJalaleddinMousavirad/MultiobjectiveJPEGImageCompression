...
# -*- coding: utf-8 -*-
"""
EnNSGAII is an Energy-aware Non-dominated Sorting Genetic Algorithm for JPEG Image Compression
...
path = glob.glob("/home/socialab/EnNSGA2/*.bmp")
cv_img = []
for img in path:
    ...
    class MyProblem(ElementwiseProblem):
        ...
        def _evaluate(self, x, out, *args, **kwargs):                
            ...
            """
            cv2.cv.SaveImage(, cv2.fromarray(reImg))
            """
