...
# -*- coding: utf-8 -*-
"""
EnMOGA is an Energy-aware multi-objective Genetic Algorithm for JPEG Image Compression
...
path = glob.glob("/home/socialab/EnMOGA/*.bmp")
cv_img = []
for img in path:
    ...
    class MyProblem(ElementwiseProblem):
        ...
        def _evaluate(self, x, out, *args, **kwargs):                
            ...
            CQT_row=ind[64:128]  ## chromonic quantisation table as a row
    ...
    for ind in range(30):
        ...
        mutation=get_mutation("real_pm", eta=20, prob=0.3),
