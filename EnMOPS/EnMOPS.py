...
# -*- coding: utf-8 -*-
"""
EnMOPS is an Energy-aware multi-objective Particle Search for JPEG Image Compression
...
path = glob.glob("/home/socialab/Postdoc/Jpeg/Energy_Aware_JPEG/Ver2/Pattern_Search/*.bmp")
cv_img = []
